...
floor0=(STRUCT([COLOR(GREEN)(pavimento), COLOR([0.98,0.78,0.33])(gradoni),
	COLOR([0.94,0.71,0.2])(colonnato), COLOR([0.29,0.22,0.07])(plinti), 
	COLOR([0.23,0.16,0])(muri_interni)]))
...
pts_pianerottolo=[[0,0],[8,0],[0,16],[8,16]]
pianerottolo_=AA(MK)(pts_pianerottolo)
pianerottolo__=AA(JOIN)([pianerottolo_[0:5]])
pianerottolo=STRUCT(pianerottolo__)
pianerottolo=PROD([pianerottolo,Q(4)])
pianerottolo=T([1,2,3])([11,-5,35])(pianerottolo)

pts_scalino=[[0,0],[3,0],[0,6],[3,6]]
scalino_=AA(MK)(pts_scalino)
scalino__=AA(JOIN)([scalino_[0:5]])
scalino=STRUCT(scalino__)
scalino=PROD([scalino,Q(1)])
scalino=T([1,2,3])([19,-5,34])(scalino)
scalinata=STRUCT([scalino, T([1,3])([3,-1])]*36)




scale=STRUCT([COLOR(BLACK)(pianerottolo),COLOR([0.27,0.25,0.25])(scalinata),])


VIEW(STRUCT([floor0,floor1, scale]))
