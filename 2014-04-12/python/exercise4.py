...
tronco = larRod([1.4,17.])([32,1])
tronco = STRUCT(MKPOLS(tronco))
palla = larBall(6)([18,36])
palla=STRUCT(MKPOLS(palla))
palla=T(3)(17)(palla)

albero=STRUCT([COLOR([0.69, 0.25, 0.25])(tronco), COLOR(GREEN)(palla)])
albero1=T([1,2])([-30,-55])(albero)
linea_alberi1=STRUCT([albero1, T(1)(30)]*8)
albero2=T([1,2])([-70,155])(albero)
linea_alberi2=STRUCT([albero2, T(1)(30)]*8)

VIEW(STRUCT([floor0,floor1, linea_alberi1, linea_alberi2 , 
	COLOR([0.96,0.8,0.25])(building1),COLOR([0.96,0.8,0.25])(building2)]))
